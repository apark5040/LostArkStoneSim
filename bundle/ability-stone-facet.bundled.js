  ...
  : (t) =>
      t instanceof CSSStyleSheet
        ? ((t) => {
            ...
            return ((t) => new o('string' == typeof t ? t : t + '', void 0, s))(
              i
            );
          })(t)
        : t;
...
const r = window,
  ...
  u = (t, i) => i !== t && (i == i || t == t),
  v = {attribute: !0, type: String, converter: a, reflect: !1, hasChanged: u};
      ...
      const t = e.getPropertyOptions(o),
        n =
          'function' == typeof t.converter
            ...
            : a;
      (this._$El = o),
        (this[o] = n.fromAttribute(i, t.type)),
        (this._$El = null);
    }
  }
  requestUpdate(t, i, s) {
...
(p.finalized = !0),
  ...
  (null !== (l = r.reactiveElementVersions) && void 0 !== l
    ? l
...
const f = window,
  ...
  I = new WeakMap(),
  H = S.createTreeWalker(S, 129, null, !1),
  P = (t, i) => {
    const s = t.length - 1,
      e = [];
    let o,
    ...
    for (let i = 0; i < s; i++) {
      ...
      let r,
        ...
        d = -1,
        c = 0;
      for (; c < s.length && ((l.lastIndex = c), (h = l.exec(s)), null !== h); )
        (c = l.lastIndex),
          l === C
            ? '!--' === h[1]
              ? (l = x)
            ...
            ? '>' === h[0]
              ...
              : ((d = l.lastIndex - h[2].length),
                (r = h[1]),
                (l = void 0 === h[3] ? N : '"' === h[3] ? M : j))
            : l === M || l === j
            ? (l = N)
            : l === x || l === E
            ? (l = C)
            : ((l = N), (o = void 0));
      const a = l === N && t[i + 1].startsWith('/>') ? ' ' : '';
      n +=
        l === C
          ? s + $
          : d >= 0
          ? (e.push(r), s.slice(0, d) + '$lit$' + s.slice(d) + g + a)
          : s + g + (-2 === d ? (e.push(void 0), i) : a);
    }
    const r = n + (t[s] || '<?>') + (2 === i ? '</svg>' : '');
    if (!Array.isArray(t) || !t.hasOwnProperty('raw'))
      throw Error('invalid template strings array');
    return [void 0 !== m ? m.createHTML(r) : r, e];
  };
class D {
  constructor({strings: t, _$litType$: i}, s) {
    ...
    for (; null !== (e = H.nextNode()) && r.length < l; ) {
      if (1 === e.nodeType) {
        if (e.hasAttributes()) {
          const t = [];
          for (const i of e.getAttributeNames())
            if (i.endsWith('$lit$') || i.startsWith(g)) {
              ...
              if ((t.push(i), void 0 !== s)) {
                const t = e.getAttribute(s.toLowerCase() + '$lit$').split(g),
                  i = /([.?@])?(.*)/.exec(s);
                r.push({
                  type: 1,
                  index: o,
              ...
              } else r.push({type: 6, index: o});
            }
          for (const i of t) e.removeAttribute(i);
        }
        if (U.test(e.tagName)) {
          const t = e.textContent.split(g),
            i = t.length - 1;
          if (i > 0) {
            e.textContent = y ? y.emptyScript : '';
            for (let s = 0; s < i; s++)
              e.append(t[s], k()), H.nextNode(), r.push({type: 2, index: ++o});
            e.append(t[i], k());
          }
        }
      } else if (8 === e.nodeType)
        if (e.data === w) r.push({type: 2, index: o});
        else {
          let t = -1;
          for (; -1 !== (t = e.data.indexOf(g, t + 1)); )
            r.push({type: 7, index: o}), (t += g.length - 1);
        }
      o++;
    }
  }
  ...
  let h =
    void 0 !== e
      ? null === (o = s._$Cl) || void 0 === o
        ...
        : o[e]
      : s._$Cu;
  const d = A(i) ? void 0 : i._$litDirective$;
  return (
    (null == h ? void 0 : h.constructor) !== d &&
      (null === (n = null == h ? void 0 : h._$AO) ||
        void 0 === n ||
        n.call(h, !1),
      void 0 === d ? (h = void 0) : ((h = new d(t)), h._$AT(t, s, e)),
      void 0 !== e
        ? ((null !== (l = (r = s)._$Cl) && void 0 !== l ? l : (r._$Cl = []))[
            e
          ] = h)
        : (s._$Cu = h)),
  ...
  p(t) {
    ...
    for (; void 0 !== h; ) {
      if (l === h.index) {
        let i;
        2 === h.type
          ? (i = new L(n, n.nextSibling, this, t))
          : 1 === h.type
          ? (i = new h.ctor(n, h.name, h.strings, this, t))
          : 6 === h.type && (i = new Q(n, this, t)),
          this.v.push(i),
          (h = e[++r]);
      }
      l !== (null == h ? void 0 : h.index) && ((n = H.nextNode()), l++);
    }
    return o;
  }
  m(t) {
...
class L {
  ...
  T(t) {
    ...
    const {values: s, _$litType$: e} = t,
      o =
        'number' == typeof e
          ? this._$AC(t)
          : (void 0 === e.el && (e.el = D.createElement(e.h, this.options)), e);
  ...
  _$AC(t) {
    ...
    return void 0 === i && I.set(t.strings, (i = new D(t))), i;
  }
  O(t) {
    ...
    for (const o of t)
      e === i.length
        ? i.push((s = new L(this.S(k()), this.S(k()), this, this.options)))
        : (s = i[e]),
        s._$AI(o),
        e++;
  ...
  _$AI(t, i = this, s, e) {
    ...
    if (void 0 === o)
      ...
      for (t = o[0], l = 0; l < o.length - 1; l++)
        (r = z(this, e[s + l], i, l)),
          r === R && (r = this._$AH[l]),
          n || (n = !A(r) || r !== this._$AH[l]),
          r === T ? (t = T) : t !== T && (t += (null != r ? r : '') + o[l + 1]),
          (this._$AH[l] = r);
    }
    n && !e && this.P(t);
  }
...
class G extends B {
  ...
  _$AI(t, i = this) {
    var s;
    if ((t = null !== (s = z(this, t, i, 0)) && void 0 !== s ? s : T) === R)
      return;
    const e = this._$AH,
      o =
        (t === T && e !== T) ||
...
const W = f.litHtmlPolyfillSupport;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
var Y, F;
null == W || W(D, L),
  (null !== (b = f.litHtmlVersions) && void 0 !== b
    ? b
    : (f.litHtmlVersions = [])
  ).push('2.3.1');
class V extends p {
...
(V.finalized = !0),
  ...
  null === (Y = globalThis.litElementHydrateSupport) ||
    void 0 === Y ||
    Y.call(globalThis, {LitElement: V});
...
class tt extends V {
  ...
  _onClick(t, i) {
    const s = this.getElementsByClassName(
      t + '-row'
    )[0].firstElementChild.querySelector('.' + i + '-diamond.empty');
    if (null !== s) {
      let t = s.classList;
      Math.floor(100 * Math.random()) <= this.chance
        ? (t.add(i + '-success'),
          this.chance > 25 && (this.chance -= 10),
          'blue' == i ? this.blue++ : this.red++)
        : (t.add('failure'), this.chance < 75 && (this.chance += 10)),
        t.remove('empty');
    }
  }
  renderDiamonds(t, i) {
    let s = [],
      e = 0;
    for (; e < i; ) s.push(O`<div class="${t}-diamond empty"></div>`), e++;
    return s;
  }
  updateDiamonds(t) {
    (this.numOfDiamonds = t), this.refresh();
  }
  refresh() {
    (this.chance = 75),
      (this.blue = 0),
      (this.red = 0),
      this.querySelectorAll('.red-success, .blue-success, .failure').forEach(
        (t) => {
          t.classList.remove('red-success'),
            t.classList.remove('blue-success'),
            t.classList.remove('failure'),
            t.classList.add('empty');
        }
      );
  }
}
window.customElements.define('ability-stone-facet', tt);
export {tt as AbilityStoneFacet};
